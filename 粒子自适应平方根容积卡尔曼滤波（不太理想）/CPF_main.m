...
%% 主函数
for i=2:N
    [Xupf(:,i),P,xold,xm,flag,C0] = UPF_fun(xold,xm,P,Z(:,i),R,Q,f,h,n,n_x,n_z,flag,C0);
end
%% 画图
T = 1:N;
figure;
...
%% 
function [x,P,xold,xm,flag,C0] = UPF_fun(xold,xm,P,z,R,Q,f,h,n,n_x,n_z,flag,C0)
    ...
    for i = 1:n
        %xold_in(:,i) = f(xold(:,i));
        [P(:,:,i),xm(:,i),flag(i),C0(i)] = asckf(f,xm(:,i),z,h,P(:,:,i),Q,R,flag(i),C0(i));
